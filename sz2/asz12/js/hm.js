(function () {
    var h = {}, mt = {}, c = {
        id: "2887117955c32dbc93ef83f75cfdbfed",
        dm: ["m.bjzjhl.com/awap"],
    ...
    (mt.r.Y = function () {
        ...
        (function () {
            if (!f) if (f = s, "complete" === document.readyState) a.B = s; else if (document.addEventListener) document.addEventListener("DOMContentLoaded",
                e, w), window.addEventListener("load", a, w); else if (document.attachEvent) {
    ...
    (function () {
        ...
        function b() {
            ...
            if ((!n || !k) && g && l) u = s, p = +new Date; else if (n && k && (!g || !l)) u = w, q += +new Date - p;
            n = g;
            k = l;
            y = setTimeout(b, 100)
        }
        ...
        function f(a) {
            var p = document, k = "";
            if (a in p) k = a; else for (var b = ["webkit", "ms", "moz", "o"], q = 0; q < b.length; q++) {
        ...
        var e = mt.event, m = h.G, n = s, g = s, k = s, l = s, v = +new Date, p = v, q = 0, u = s,
    ...
    (function () {
        var a = mt.lang, b = h.w, f = h.load, d = {
            za: function (e) {
                if ((window._dxt === r || a.d(window._dxt, "Array")) && "undefined" !== typeof h.b) {
                    var d = h.b.I();
                    f([b.protocol, "../../../../datax.baidu.com/xca52.js?si=", c.id, "&dm=", encodeURIComponent(d)].join(""), e)
                }
            }, Ka: function (b) {
    ...
    (function () {
        ...
        var f = mt.lang, d = mt.l, e = h.w, m = h.G, n = h.ea, g = {
            s: [], C: 0, V: w, init: function () {
                g.e = 0;
                m.c("pv-b", function () {
                    g.fa();
                    g.ha()
                ...
                if (f.d(b, "Object")) {
                    ...
                    if (900 >= m) l.call(this, b); else for (var m = Math.ceil(m / 900), p = "block|" + Math.round(Math.random() *
    ...
    (function () {
        ...
        var b = mt.url, f = mt.O, d = mt.P, e = mt.lang, m = mt.cookie, n = mt.j,
            g = mt.localStorage, k = mt.sessionStorage, l = h.w, v = h.G;
        a.prototype = {
            K: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                for (var d = 0; d < c.dm.length; d++) if (-1 <
                    c.dm[d].indexOf("http://kh.gazyzl.com/")) {
                ...
                for (var a = 0, b = c.dm.length; a < b; a++) {
                    var d = c.dm[a];
                    if (-1 < d.indexOf("http://kh.gazyzl.com/") && this.W(document.location.href, d)) return d.replace(/^[^\/]+(\/.*)/, "$1") + "/"
                }
                return "/"
            }, qa: function () {
                ...
                var a = document.location.hash.substring(1), d = RegExp(c.id),
                    e = -1 < document.referrer.indexOf(l.ba), f = b.k(a, "jn"),
    ...
    (function () {
        var a = mt.r, b = mt.event, f = mt.url, d = mt.l;
        try {
            if (window.performance && performance.timing && "undefined" !== typeof h.b) {
                var e = +new Date, m = function (a) {
    ...
    (function () {
        var a = mt.j, b = mt.lang, f = mt.event, d = mt.l;
        if ("undefined" !== typeof h.b && (c.med || (!a.T || 7 < a.ya) && c.cvcc)) {
            ...
            if ("undefined" !== typeof g && "undefined" !== typeof n) {
                ...
                var u = function (a, d) {
                    ...
                    if (b.d(d, "Array") || b.d(d, "NodeList")) for (var e = 0, f = d.length; e < f; e++) if (q === d[e]) return v(m + a + "/" + (e + 1), d[e]), w
                };
    ...
    (function () {
        var a = mt.r, b = mt.lang, f = mt.event, d = mt.l;
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.b) {
            var f = +new Date, d = {n: "anti", sb: 0, kb: 0, clk: 0}, e = function () {
                h.b.a.et = 86;
    ...
    (function () {
        ...
        a.prototype = {
            Aa: function (a) {
                ...
                var a = this;
                this.la(function (d) {
                    d !== r && "" !== d && (b.log("../../../../datax.baidu.com/xee85.gif?dm=" +
