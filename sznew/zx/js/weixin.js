...
function sendmess() {
	...
	if (clickNumber == 0) {
		...
		setTimeout(function(){document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="left"> <images src="images/header.jpg" width="40px"><div> <i></i> 您好，请简单描述下您的症状！<br>收到请回复以下序列号:<br>1.湿疹<br>2.慢性湿疹<br>3.全身湿疹<br>4.脸部湿疹<br>5.手足湿疹<br>6.皮肤湿疹!</div></div><div class="ly-clear"></div></div>';window.scrollTo(0,document.body.scrollHeight);},2000);

		document.getElementById('keyword').value ='';
	}else if(clickNumber == 1){
		document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="right"> <images src="images/header2.jpg" width="40px"><div> <i></i> ' + document.getElementById('keyword').value + '</div></div><div class="ly-clear"></div></div>';
		setTimeout(function(){document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="left"> <images src="images//header.jpg" width="40px"><div> <i></i> 您好，由于目前咨询人数过多，建议您添加老师个人微信号：<span style="color:#fff;background:#f00;padding:0 5px;">' + WeiXinID + '</span>（长按微信号复制添加），专业的老师将会亲自一对一回复您。 </div></div><div class="ly-clear"></div></div>';window.scrollTo(0,document.body.scrollHeight);},2000);

		document.getElementById('keyword').value ='';
	} else {
		document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="right"> <images src="images/header2.jpg" width="40px"><div> <i></i> ' + document.getElementById('keyword').value + '</div></div><div class="ly-clear"></div></div>';
		setTimeout(function(){document.getElementById('messbox').innerHTML = document.getElementById('messbox').innerHTML + '<div class="line"><div class="left"> <images src="images/header.jpg" width="40px"><div> <i></i> 优先处理！请加老师个人微信号：<span style="color:#fff;background:#f00;padding:0 5px;">' + WeiXinID + '</span>（长按微信号复制添加）。 </div></div><div class="ly-clear"></div></div>';window.scrollTo(0,document.body.scrollHeight);},2000);
		document.getElementById('keyword').value ='';
	}
	clickNumber++;
}
