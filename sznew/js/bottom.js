...
document.write('<img style="float: left; width: 40px; height: 40px;" width="40" height="40" src="images/wx.gif" tppabs="images/foot1.png" border="0">');
...
document.write('<span onclick="clickSpan()" style="color:#F00; font-weight:bold" name="wx1"><script>document.write(Arr);</script></span>');
document.write('</strong>');
document.write('</span> 按下复制<br>立即添加获取湿疹治疗方法>>></span>');
document.write('</div>');
